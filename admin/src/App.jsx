...
import AllCar from "./pages/MANAGE_CAR/AllCar";
import CarDetail from "./pages/MANAGE_CAR/CarsDetail";
import AllCraneMan from "./pages/MANAGE_CRANE-MAN/AllCraneMan";
import ViewCraneMan from "./pages/MANAGE_CRANE-MAN/ViewCraneMan";
import EditCraneMan from "./pages/MANAGE_CRANE-MAN/EditCraneMan";
import AddCraneMan from "./pages/MANAGE_CRANE-MAN/AddCraneMan";
import AllRc from "./pages/MANAGE_RC/AllRc";
import RcDetails from "./pages/MANAGE_RC/RcDetails";
import AllContactMessages from "./pages/MANAGE_INQUIRY/AllContact";
import AllQuoteRequests from "./pages/MANAGE_INQUIRY/AllQuoteRequests";
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<AdminLayout />}>
            ...
            {/* Crane Man Related */}
            <Route path="/crane-men" element={<AllCraneMan />} />
            <Route path="/view-crane-man/:id" element={<ViewCraneMan />} />
            <Route path="/edit-crane-man/:id" element={<EditCraneMan />} />
            <Route path="/add-crane-man" element={<AddCraneMan />} />

            {/* Car Related */}
            <Route path="/cars" element={<AllCar />} />
            <Route path="/view-car/:id" element={<CarDetail />} />
            {/* <Route path="/edit-car/:id" element={<EditUser />} /> */}

            {/* RCs Related */}
            <Route path="/all-rcs" element={<AllRc />} />
            <Route path="/view-rc/:id" element={<RcDetails />} />
            {/* <Route path="/edit-rc/:id" element={<EditUser />} /> */}

            {/* Inquiry Related */}
            <Route path="/all-contact" element={<AllContactMessages />} />
            <Route path="/all-quote-requests" element={<AllQuoteRequests />} />
            ...
            <Route
              path="/check-applies/candidates/:id"
              element={<ViewApply />}
            />
            ...
            <Route
              ...
              element={<CreateAndEditService />}
            />
            <Route
              path="/cms/services/edit/:id"
              element={<CreateAndEditService />}
            />
