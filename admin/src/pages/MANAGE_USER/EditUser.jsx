        ...
        <div className="min-h-screen bg-gray-50 pb-16">
            ...
            <div className="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between sticky top-0 z-10">
                <div className="flex items-center gap-2 text-sm text-gray-500">
                    ...
                    <span>/</span>
                    <button onClick={() => navigate(`/view-user/${id}`)} className="hover:text-gray-800 transition">{form.name || "User"}</button>
                    <span>/</span>
            ...
            <form onSubmit={handleSubmit} className="max-w-4xl mx-auto px-6 pt-6 space-y-4">
                ...
                {/* Bank Details */}
                <div className={sectionCls}>
                    <p className="text-xs font-semibold text-gray-400 uppercase tracking-widest mb-4">Bank Details</p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                ...
                {/* UPI Details */}
                <div className={sectionCls}>
                    <p className="text-xs font-semibold text-gray-400 uppercase tracking-widest mb-4">UPI Details</p>
                    <div className="max-w-sm">
                        <label className={labelCls}>UPI ID</label>
                        <input
                            value={form.upiDetails.upiId}
                            onChange={(e) => handleNestedChange("upiDetails", "upiId", e.target.value)}
