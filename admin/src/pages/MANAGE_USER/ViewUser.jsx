...
export default function ViewUser() {
  ...
  if (loading) return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: 400, flexDirection: "column", gap: 14, fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <p style={{ color: "#9ca3af", fontSize: 14 }}>Loading user details...</p>
  ...
  if (!user) return (
    <div style={{ padding: 40, textAlign: "center", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <p style={{ color: "#6b7280", fontSize: 15 }}>User not found.</p>
        ...
        <div>
          ...
          <Section title="Bank Details" icon={CreditCard}>
            {user.bankDetails?.accountNumber ? (
              <Grid>
                <Field label="Account Holder" value={user.bankDetails.accountHolderName} />
                <Field label="Account Number" value={user.bankDetails.accountNumber} />
                <Field label="IFSC Code"      value={user.bankDetails.ifscCode} />
                <Field label="Bank Name"      value={user.bankDetails.bankName} />
              </Grid>
            ) : (
              <p style={{ margin: 0, fontSize: 13, color: "#9ca3af", fontStyle: "italic" }}>No bank details added</p>
            )}
          </Section>

          {/* UPI Details */}
          <Section title="UPI Details" icon={Shield}>
            {user.upiDetails?.upiId ? (
              <Field label="UPI ID" value={user.upiDetails.upiId} />
            ) : (
              <p style={{ margin: 0, fontSize: 13, color: "#9ca3af", fontStyle: "italic" }}>No UPI details added</p>
            )}
          </Section>
