...
const brands = [
  { img: '/assets/imgs/brand/brand-2/icon-1.png', name: 'Opel' },
  { img: '/assets/imgs/brand/brand-2/icon-2.png', name: 'BMW' },
  { img: '/assets/imgs/brand/brand-2/icon-3.png', name: 'Mercedes' },
  { img: '/assets/imgs/brand/brand-2/icon-4.png', name: 'Ford' },
  { img: '/assets/imgs/brand/brand-2/icon-5.png', name: 'Peugeot' },
  { img: '/assets/imgs/brand/brand-2/icon-6.png', name: 'Hyundai' },
  { img: '/assets/imgs/brand/brand-2/icon-7.png', name: 'Toyota' },
  { img: '/assets/imgs/brand/brand-2/icon-8.png', name: 'Nissan' },
  { img: '/assets/imgs/brand/brand-2/icon-9.png', name: 'Mazda' },
];
    ...
    <div className="pt-40 pb-80">
      <div className="container">
        <div className="box-search-category">
          ...
          <div className="carouselTicker carouselTicker-left box-list-brand-car flex-lg-nowrap justify-content-lg-between gap-3 justify-content-center">
              ...
              {[...brands, ...brands].map((brand, index) => (
                <li key={index} className="carouselTicker__item">
                  <div className="item-brand-2">
                    ...
                    />
                    <span className="text-md-bold mt-2">{brand.name}</span>
                  </div>
                </li>
              ))}
            </ul>
